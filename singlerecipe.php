  ...
  <main id="page">
    ...
    <div class="recipe-section">
      ...
      <ol class="recipe-instructions">
        <li>Preheat the oven to 350°F. In a small bowl whisk together the egg, milk, and Worcestershire sauce. In a separate small bowl, stir together the breadcrumbs, Italian seasoning, garlic powder, salt, and pepper. Mince the onion.</li>
        ...
        <li>Bake the meatloaf for 50-55 minutes, or until the internal temperature reaches 165°F. Allow the meatloaf to rest for 5-10 minutes after baking, then slice and serve.</li>
      </ol>
